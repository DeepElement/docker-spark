...
RUN curl -s http://d3kbcqa49mib13.cloudfront.net/spark-2.1.2-bin-hadoop2.7.tgz | tar -xz -C /usr/local/
RUN cd /usr/local && ln -s spark-2.1.2-bin-hadoop2.7 spark
ENV SPARK_HOME="/usr/local/spark-2.1.2-bin-hadoop2.7"
