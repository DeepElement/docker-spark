...
RUN curl -s http://d3kbcqa49mib13.cloudfront.net/spark-2.0.1-bin-hadoop2.3.tgz | tar -xz -C /usr/local/
RUN cd /usr/local && ln -s spark-2.0.1-bin-hadoop2.3 spark
ENV SPARK_HOME="/usr/local/spark-2.0.1-bin-hadoop2.3"
